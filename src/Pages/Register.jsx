...
const Register = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>FeedX | Register</title>
      </Helmet>
      <div>
        <div className="hero min-h-screen ">
          <div>
            <div className="my-10">
                <p className="text-4xl text-center text-sky-700 font-bold ">FeedX</p>
            ...
            <div className="w-full shadow-2xl lg:w-96">
              <form onSubmit={createUserHandler} className="card-body">
                ...
                <div className="form-control mt-6">
                  <button className="p-3 bg-sky-700 rounded-lg text-white">Register</button>
                </div>
                <div>
